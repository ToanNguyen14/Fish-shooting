...
(function () {
	...
	R.initResources = function () {
		...
		var fish1 = {
			...
			mixin: { coin: 1, captureRate: 0.45, maxNumGroup: 8, minSpeed: 0.5, maxSpeed: 1.2, regX: 35, regY: 12, useFrames: true, interval: 10 }
		};
		...
		var fish2 = {
			...
			mixin: { coin: 2, captureRate: 0.40, maxNumGroup: 6, minSpeed: 0.5, maxSpeed: 1.2, regX: 58, regY: 20, useFrames: true, interval: 10 }
		};
		...
		var fish3 = {
			...
			mixin: { coin: 3, captureRate: 0.35, maxNumGroup: 6, minSpeed: 0.5, maxSpeed: 1.2, regX: 52, regY: 18, useFrames: true, interval: 10 }
		};
		...
		var fish4 = {
			...
			mixin: { coin: 4, captureRate: 0.30, maxNumGroup: 6, minSpeed: 0.5, maxSpeed: 1.2, regX: 57, regY: 18, useFrames: true, interval: 10 }
		};
		...
		var fish5 = {
			...
			mixin: { coin: 5, captureRate: 0.25, maxNumGroup: 5, minSpeed: 0.5, maxSpeed: 1.2, regX: 67, regY: 50, useFrames: true, interval: 10 }
		};
		...
		var fish6 = {
			...
			mixin: { coin: 6, captureRate: 0.20, maxNumGroup: 3, minSpeed: 0.5, maxSpeed: 1.2, regX: 65, regY: 25, useFrames: true, interval: 10 }
		};
		...
		var fish7 = {
			...
			mixin: { coin: 7, captureRate: 0.16, maxNumGroup: 5, minSpeed: 0.5, maxSpeed: 0.8, regX: 40, regY: 50, useFrames: true, interval: 10 }
		};
		...
		var fish8 = {
			...
			mixin: { coin: 8, captureRate: 0.12, maxNumGroup: 3, minSpeed: 0.5, maxSpeed: 0.8, regX: 90, regY: 50, useFrames: true, interval: 10 }
		};
		...
		var fish9 = {
			...
			mixin: { coin: 9, captureRate: 0.08, maxNumGroup: 2, minSpeed: 0.5, maxSpeed: 0.8, regX: 120, regY: 70, useFrames: true, interval: 10 }
		};
		...
		var fish10 = {
			...
			mixin: { coin: 10, captureRate: 0.04, maxNumGroup: 2, minSpeed: 0.5, maxSpeed: 0.8, regX: 100, regY: 80, useFrames: true, interval: 10 }
		};
		...
		var shark1 = {
			...
			mixin: { coin: 30, captureRate: 0.03, maxNumGroup: 1, minSpeed: 0.5, maxSpeed: 0.6, regX: 350, regY: 130, useFrames: true, interval: 10 }
		};
		...
		var shark2 = {
			...
			mixin: { coin: 50, captureRate: 0.015, maxNumGroup: 1, minSpeed: 0.5, maxSpeed: 0.6, regX: 350, regY: 130, useFrames: true, interval: 10 }
		};
